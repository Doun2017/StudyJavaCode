...
public class MappedIO {
    ...
    private static Tester[] tests = {new Tester("Stream Write") {
        public void test() throws IOException {
            ...
            for (int i = 0; i < numOfInts; i++) dos.writeInt(i);
            dos.close();
        }
        ...
        public void test() throws IOException {
            ...
            for (int i = 0; i < numOfInts; i++) dis.readInt();
            dis.close();
        }
        ...
        public void test() throws IOException {
            for (int i = 1; i < numOfUbuffInts; i++) {
                ...
                ib.put(new double[]{11.2, 2.42, 4.7, 99.1, 143.33, 811.3, 1016.22});
...
//                System.out.println(i);
    ...
    public static void main(String[] args) {
        for (Tester test : tests) test.runTest();
    }
