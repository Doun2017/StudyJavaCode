...
public class SimpleHashMapOfArraylist37<K, V> extends AbstractMap<K, V>  {
    ...
    public static void main(String[] args) {
        SimpleHashMapOfArraylist37<String, String> m = new SimpleHashMapOfArraylist37<String, String>();
